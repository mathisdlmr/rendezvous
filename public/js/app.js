...
"use strict";
/*!************************************!*\
  !*** ./resources/js/chipsInput.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
window.addEventListener('load', function () {
  var chipsInputElements = document.querySelectorAll('.chip-input');
  chipsInputElements.forEach(function (chipsInputElement) {
    var id = chipsInputElement.id;
    console.log(id);
    initializeChipsInput(id);
  });
});
function initializeChipsInput(id) {
  var chipContainer = document.getElementById('chip-container-' + id);
  var chips = document.getElementById(id).value.split(',').map(function (chip) {
    return chip.trim();
  });
  ...
  chips.forEach(function (chip) {
    ...
    var chipTextContent = document.createElement('span');
    chipTextContent.textContent = chip;
    chipElement.appendChild(chipTextContent);
    var chipCloseButton = document.createElement('button');
  ...
  document.getElementById('chip-button-' + id).addEventListener('click', function () {
    console.log('click');
    addChip(id);
  });
}
function addChip(id) {
  var chipText = document.getElementById('chip-input-' + id).value;
  if (chipText.trim() !== '') {
    var chipContainer = document.getElementById('chip-container-' + id);
...
function updateChipsInput(id) {
  var chipContainer = document.getElementById('chip-container-' + id);
  var chips = Array.from(chipContainer.querySelectorAll('.badge span')).map(function (chip) {
